...
| Standard mobile hardware | Android `minSdkVersion` is 26, matching Android 8.0+, and the included iOS project targets the same React Native flow for iOS 12+. The native stack uses CPU-capable TFLite and avoids GPU-only assumptions. |
